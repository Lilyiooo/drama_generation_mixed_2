...
class TaijiClient:
    """
    Taiji OpenAI-compatible API client.
    接口文档：http://api.taiji.woa.com
    """
    ...
    def _load_config(self):
        ...
        url = config["API_URLS"]["taiji"]
        token = config["API_KEYS"]["taiji"]
        return url, token
    ...
    def chat(
        ...
        **llm_params,
        ...
        if messages[-1]["role"] == "assistant":
            messages = messages[:-1]  # 去掉末尾 assistant 占位
