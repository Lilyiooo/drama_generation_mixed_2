#!/usr/bin/env bash
# Usage: bash run_local_nmf_with_obligations.sh [--dry-run | --restart | other evaluator options]
set -euo pipefail
EVAL_DIR="$(cd -- "$(dirname -- "${BASH_SOURCE[0]}")" && pwd)"
TASK_ROOT=/inspire/hdd/global_user/hesiyang-CZXS25210137
SOURCE_DIR="$TASK_ROOT/drama-generation/outputs/qwen36_27b_88_outline_nmf_20260917_124731"
GEN_PYTHON="${PYTHON_BIN:-$TASK_ROOT/anaconda3/bin/python3}"
label=nmf_with_obligations_20260917_124731
