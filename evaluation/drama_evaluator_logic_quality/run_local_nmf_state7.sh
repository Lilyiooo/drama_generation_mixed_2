#!/usr/bin/env bash
# Usage: bash run_local_nmf_state7.sh [--dry-run | --restart | other evaluator options]
set -euo pipefail
EVAL_DIR="$(cd -- "$(dirname -- "${BASH_SOURCE[0]}")" && pwd)"
TASK_ROOT=/inspire/hdd/global_user/hesiyang-CZXS25210137
SOURCE_DIR="$TASK_ROOT/drama_operator_new_v9_future5_state2_complete/drama_operator_new_v9_future5_state2_complete_simple_nmf_state7/output/qwen36_27b_88_outline_nmf_state7_20260917_021943"
GEN_PYTHON="${PYTHON_BIN:-$TASK_ROOT/anaconda3/bin/python3}"
label=nmf_state7_20260917_021943
